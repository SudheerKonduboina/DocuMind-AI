...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-luxury-sage/10 rounded-full blur-[120px] animate-pulse" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-luxury-gold/10 rounded-full blur-[120px] animate-pulse animate-delay-300" />
      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="text-center mb-10">
          <h1 className="text-5xl font-serif mb-4 luxury-gradient-text">Welcome Back</h1>
          <p className="text-luxury-sage font-medium tracking-widest uppercase text-xs">Enter your details to continue</p>
        </div>
        ...
        <div className="luxury-card relative group">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-4">
            {error && (
              <div className="p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-2xl text-sm border border-red-100 dark:border-red-900/30 animate-shake">
                {error}
              </div>
            )}
          ...
          <div className="mt-8 pt-8 border-t border-luxury-dark/5 dark:border-white/5 text-center">
            <p className="text-sm opacity-60">
              ...
              <Link to="/register" className="text-luxury-sage font-semibold hover:underline">
                Create one now
              </Link>
            </p>
          </div>
