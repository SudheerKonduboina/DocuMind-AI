...
def main():
    ...
    print(
        "Current config: host=localhost, port=5432, db=ai_doc_qa, user=user, password=password"
    )
    ...
    print("\n" + "=" * 60)
    print(
        "Please update PostgreSQL credentials in the script and uncomment the migration line."
    )
    print("=" * 60)
