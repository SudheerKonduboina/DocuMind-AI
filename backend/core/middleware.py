...
class RequestIDMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        logger.info(f"Request started | method: {request.method} | path: {request.url.path} | request_id: {request_id}")
        ...
        logger.info(f"Request completed | status: {response.status_code} | request_id: {request_id}")
