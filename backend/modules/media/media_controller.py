...
class MediaController:
    ...
    def _register_routes(self):
        ...
        self.router.get("/{document_id}/transcript", response_model=TranscriptWithSegmentsResponse)(self.get_transcript)
        self.router.get("/{document_id}/segments", response_model=list[TranscriptSegmentResponse])(self.get_transcript_segments)
        self.router.delete("/{document_id}/transcript", status_code=status.HTTP_204_NO_CONTENT)(self.delete_transcript)
