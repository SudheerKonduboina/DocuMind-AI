...
class SummarizationController:
    ...
    def _register_routes(self):
        ...
        self.router.get("/{document_id}", response_model=SummaryResponse)(self.get_summary)
        self.router.post("/{document_id}", response_model=SummaryResponse, status_code=status.HTTP_201_CREATED)(self.generate_summary)
        self.router.post("/{document_id}/regenerate", response_model=SummaryResponse)(self.regenerate_summary)
        self.router.delete("/{document_id}", status_code=status.HTTP_204_NO_CONTENT)(self.delete_summary)
